...
const steps = [
  ...
  },
  {
    icon: 'explore',
    title: '在知识的海洋中航行',
    content: '使用左侧的侧边栏（在手机上点击左上角菜单按钮展开），可以轻松切换到不同功能区，如【决策仪表盘】、【数据模型】和【学习路径】。',
  },
  {
    icon: 'analytics',
    title: '探索交互式模型',
    content: '应用的核心在于【数据模型】。在这里，您可以深入了解每一种统计模型，查看它们在医美行业的具体应用，并与动态图表进行交互。',
  },
  {
    icon: 'psychology',
    title: '您的专属AI助教',
    content: '有任何疑问吗？随时点击右下角的AI图标，向您的专属助教提问。您甚至可以在浏览时划词，让AI即时解释！',
  },
  {
    icon: 'palette',
    title: '打造您的专属空间',
    content: '点击右上角的【设置】图标，您可以更换应用的主题颜色、调整字号，甚至定制AI的沟通风格。现在，开始您的探索之旅吧！',
  },
];
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md m-4 transform transition-all" onClick={e => e.stopPropagation()}>
        <div className="p-6 text-center">
            <div className="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-[color:rgb(var(--color-primary)/0.1)] mb-4">
                <span className="material-symbols-outlined text-4xl text-[color:rgb(var(--color-primary))]">{step.icon}</span>
            </div>
